...
export function Widget() {
    return (
        <div className="w-[448px] rounded overflow-hidden">
            ...
            {/* Seção recente */}
            <section>
                <div className="bg-zinc-300 dark:bg-zinc-950 px-5 py-2 text-sm text-zinc-600 dark:text-zinc-300">Recentes</div>
                ...
                <div className="divide-y-2 divide-zinc-400 dark:divide-zinc-950">
                    <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
                        ...
                        <div className="flex-1 flex flex-col gap-2">
                            ...
                            <div className="text-xs text-zinc-600 black:text-zinc-400 flex items-center gap-1">
                                <span>Convite</span>
                                <span>Há 3 min</span>
                            </div>
                        </div>
            ...
            {/* Seção recente */}
            <section>
                <div className="bg-zinc-300 dark:bg-zinc-950 px-5 py-2 text-sm text-zinc-600 dark:text-zinc-300">Antigas</div>
                <div className="divide-y-2 divide-zinc-400 dark:divide-zinc-950">
                    <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
                        <Rocket className="w-6 h-6 text-violet-500 mt-3" />
                        <div className="flex-1 flex flex-col gap-2">
